  ...
  return (
    <Layout withTopNav>
      <View marginTop={5} flexDirection="column" alignItems="center" height="80vh" justifyContent="center" paddingX={4}>
        <View width={600}>
          <Text
            css={{ color: foundations.colors.contrast }}
            fontSize={6}
            fontWeight="semibold"
            fontFamily="serif"
            paddingBottom={4}
          ...
          <Text fontFamily="Obelisc" paddingBottom={6} textAlign="center" css={{ color: foundations.colors.default }}>
            <Trans>
              {' '}
              Please contact your Go1 administrator to get access to this page or to make changes to your portal
              settings.
            </Trans>
          </Text>
        </View>
        <ButtonFilled color="accent" href={`https://${portal.title}/p/#/app/dashboard`}>
